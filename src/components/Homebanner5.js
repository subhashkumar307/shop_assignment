...
const HomeBannerV5 = () => {
  ...
  return (
    <>
        <BannerSlider className="home-banner-slider case-study-slider">
            <div className="slider-item position-relative">
                <img className="position-relative" src={publicUrl + "assets/img/slider/r1.jpg"} />
            </div>
            <div className="slider-item position-relative">
